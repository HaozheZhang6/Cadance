...
Across 10+ frontier models, we identify three diagnostic phenomena precluding industry-grade CAD generation: (1) a \emph{Holistic Spatial and Detailing Deficit}, marked by a persistent gap between code- and image-conditioned QA; (2) a \emph{CAD Operational Blindspot}, where models fail on essential operations without targeted SFT data; and (3) an \emph{Industrial Common Sense and Parametric Abstraction Gap}, where unwritten engineering conventions and parameter dependencies are absent from synthesized code.
