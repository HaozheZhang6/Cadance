...
(iii) our Qwen3-VL-2B reaches IoU 0.640 on the IID split (the dataset is learnable on a small backbone), yet ood-sft drops to OOD IoU 0.397 on 10 held-out mech.-transmission families, which RL on the OOD-SFT checkpoint partially recovers to 0.464 (composite score 0.588 $\to$ 0.723) --- the empirical \emph{generalisation cliff}.
