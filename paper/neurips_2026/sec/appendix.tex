...
Mixing 33\% BenchCAD / 67\% HQ for (1)/(2); 100\% HQ for (3). Backbone Qwen3-VL-2B; full hyperparameters in the released training config.
...
Table~\ref{tab:op_coverage} contrasts BenchCAD's 28 distinct CadQuery operations against prior corpora restricted predominantly to sketch+extrude.
