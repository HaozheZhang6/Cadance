...
Table~\ref{tab:dataset} reports the dataset composition; Table~\ref{tab:capability} maps each task to its sub-capability subset; Table~\ref{tab:main_eval_qa_code} reports the per-model Code-QA leaderboard (Vision-QA Table~\ref{tab:main_eval_qa_img} is in the main body); Table~\ref{tab:codegen_unified} is the unified Vision2Code leaderboard; Table~\ref{tab:family_cliff} stratifies \texttt{img2cq} by family difficulty.
