...
\caption{\textbf{Main evaluation on BenchCAD-QA, by capability axis.} Per-model accuracy across the four BenchCAD-QA capability axes: \emph{Holistic Visual Recognition}, \emph{CAD Operation Understanding}, \emph{Industrial Parametric Abstraction}, and \emph{Spatial / Code Reasoning} (\S\ref{sec:capability}). \textbf{Total score} is the weighted mean across axes. Rows with empty entries indicate models not yet evaluated.}
\label{tab:main_eval}
...
claude-opus-4.7-thinking            & 0.715 & 0.485 & 0.421 & 0.614 & 0.530 \\
gemini-3.1-pro-preview-nonthinking  & 0.750 & 0.462 & 0.536 & 0.688 & \textbf{0.587} \\
gemini-3.1-pro-preview-thinking     & 0.722 & 0.426 & 0.551 & 0.669 & 0.576 \\
