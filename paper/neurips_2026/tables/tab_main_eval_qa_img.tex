...
\caption{\textbf{Main evaluation on BenchCAD-QA (\texttt{qa\_img} modality), by capability axis.} Given multi-view renders, models answer visual CAD questions; closed-source MLLMs outperform the open-source MLLMs but remain weak on operation understanding and parametric abstraction.}
% \lei{Briefly explain the task and summarize the results here in the caption. Would be good to have up arrows for the header.}}
...
moonshot-v1-128k     & 0.556 & 0.387 & 0.427 & 0.334 & 0.442 \\
  ...
  moonshot-v1-8k-vision         & 0.600 & 0.246 & 0.465 & 0.181 & 0.447 \\                                                                    
