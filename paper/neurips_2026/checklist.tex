...
\item {\bf Experiments compute resources}
    ...
    \item[] Answer: \answerYes{}
    \item[] Justification: \S\ref{sec:exp_main} states the inference cluster (8$\times$A800-80GB nodes); \S\ref{sec:exp_training} states baseline training compute ($\approx$9 GPU-hours on the same hardware); Appendix~\ref{app:reproduce} states that BenchCAD-Lite evaluation runs in under two hours per model on a single A100.
