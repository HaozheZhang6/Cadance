...
class PipeElbowFamily(BaseFamily):
    ...
    def sample_params(self, difficulty: str, rng) -> dict:
        ...
        lead_l  = round(rng.uniform(outer_r * 0.8, outer_r * 2.5), 1)   # straight lead [mm]
        bend_r  = round(rng.uniform(outer_r * 1.5, outer_r * 3.5), 1)   # bend centerline radius [mm]
        trail_l = round(rng.uniform(outer_r * 0.8, outer_r * 2.5), 1)   # straight trail [mm]
        ...
        if difficulty in ("medium", "hard"):
            ...
            params.update(neck_radius=neck_r, neck_length=neck_l,
                          flange_radius=flange_r, flange_thickness=flange_t)
    ...
    def make_program(self, params: dict) -> Program:
        ...
        if nr and nl and fr and ft:
            ...
            ops.append(Op("union", {"ops": [
                ...
                {"name": "cylinder", "args": {"height": round(nl + ovlp, 3), "radius": round(nr, 3)}},
            ]}))
            ...
            ops.append(Op("union", {"ops": [
                ...
                {"name": "cylinder", "args": {"height": round(ft, 3), "radius": round(fr, 3)}},
            ]}))
            ...
            ops.append(Op("union", {"ops": [
                {"name": "transformed", "args": {
                    "offset": [round(ox + (nl + ovlp) / 2 - ovlp / 2, 3), 0, round(oz, 3)],
                    "rotate": [0, 90, 0],
                }},
                {"name": "cylinder", "args": {"height": round(nl + ovlp, 3), "radius": round(nr, 3)}},
            ]}))
            ...
            ops.append(Op("union", {"ops": [
                {"name": "transformed", "args": {
                    "offset": [round(ox + nl + ft / 2, 3), 0, round(oz, 3)],
                    "rotate": [0, 90, 0],
                }},
                {"name": "cylinder", "args": {"height": round(ft, 3), "radius": round(fr, 3)}},
            ]}))
            ...
            if nb and bhr:
                ...
                for i in range(nb):
                    ...
                    ops.append(Op("cut", {"ops": [
                        ...
                        {"name": "cylinder", "args": {"height": round(ft + 1.0, 3), "radius": round(bhr, 3)}},
                    ]}))
                    ...
                    ops.append(Op("cut", {"ops": [
                        {"name": "transformed", "args": {
                            "offset": [round(ox + nl + ft - 0.5, 3), y2, z2],
                            "rotate": [0, 90, 0],
                        }},
                        {"name": "cylinder", "args": {"height": round(ft + 1.0, 3), "radius": round(bhr, 3)}},
                    ]}))
