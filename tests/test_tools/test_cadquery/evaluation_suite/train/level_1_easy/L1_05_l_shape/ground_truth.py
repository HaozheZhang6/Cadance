...
- Profile drawn in XY plane, extruded in Z direction (standard convention)
...
# Create L-shaped profile in XY plane (standard convention)
result = (
    cq.Workplane("XY")
    .moveTo(0, 0)
    ...
    .close()  # Back to start
    .extrude(40)  # Extrude in Z direction
)

# Expected properties:
# - Volume: 1425 * 40 = 57,000 mm³
# - Bounding box: 50 x 60 x 40 (XY profile extruded in Z)
